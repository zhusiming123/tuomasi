  ...
  <div class="box_practise">
    ...
    >
      <ul>
        ...
        <!-- <li>
                    <p class="title">额外积分：</p>
                    <div class="content_config">
                        <p>第一名<input type="number" v-model="sendQuestion.questionDescs[3].value" />分</p>
                        <p>第二名<input type="number" v-model="sendQuestion.questionDescs[4].value" />分</p>
                        <p>第三名<input type="number" v-model="sendQuestion.questionDescs[5].value"/>分</p>                    
                    </div>
                </li> -->
...
export default({
  data(){
    return{
      ...
      sendQuestion:{"type": "","answer": "","category":0,
        "lesson": {"id":""},
        "questionDescs": [
          {
            "type": 0,
  ...
  methods:{
    ...mapMutations(["changeTabNum","changePractise"]),
    checkType(num){
      this.answer.A = 0;
      this.answer.B = 0;
      this.answer.C = 0;
