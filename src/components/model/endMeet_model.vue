<template>
    <div class="confirm_model" v-if="modelType">
        <div class="confirm_model_box">
            ...
            <p class="confirm_model_box_title">{{title}}</p>
            <p class="confirm_model_box_btn">
                <span @click="cancel" class="confirm_model_box_btn_left">{{cancelTitle}}</span>
                <span @click="makeSure" class="confirm_model_box_btn_right">{{sureTitle}}</span>
            </p>
        </div>
    </div>
</template>
